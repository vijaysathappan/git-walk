...
(function (TelemetryProperty) {
    ...
    TelemetryProperty["TemplateChannel"] = "template-channel";
    TelemetryProperty["TemplatePackageSource"] = "template-package-source";
    TelemetryProperty["TemplatePackageVersion"] = "template-package-version";
    TelemetryProperty["TemplatePackageDigest"] = "template-package-digest";
    ...
    TelemetryProperty["TeamsGraphTraceId"] = "teams-graph-trace-id";
...
})(TelemetryProperty || (exports.TelemetryProperty = TelemetryProperty = {}));
...
(function (TelemetryEvent) {
    ...
    TelemetryEvent["TeamsGraphApi"] = "teams-graph-api";
...
})(ProjectTypeProps || (exports.ProjectTypeProps = ProjectTypeProps = {}));
var TelemetrySuccess;
(function (TelemetrySuccess) {
    TelemetrySuccess["Yes"] = "yes";
    TelemetrySuccess["No"] = "no";
})(TelemetrySuccess || (exports.TelemetrySuccess = TelemetrySuccess = {}));
...
})(CustomizeResourceGroupType || (exports.CustomizeResourceGroupType = CustomizeResourceGroupType = {}));
...
})(CustomizeSubscriptionType || (exports.CustomizeSubscriptionType = CustomizeSubscriptionType = {}));
...
})(WebApplicationIdValue || (exports.WebApplicationIdValue = WebApplicationIdValue = {}));
...
})(ApiSpecTelemetryPropertis || (exports.ApiSpecTelemetryPropertis = ApiSpecTelemetryPropertis = {}));
...
function sendTelemetryEvent(component, eventName, properties, measurements) {
    ...
    globalVars_1.TOOLS?.telemetryReporter?.sendTelemetryEvent(eventName, properties, measurements);
}
function sendTelemetryErrorEvent(component, eventName, fxError, properties) {
    ...
    globalVars_1.TOOLS?.telemetryReporter?.sendTelemetryErrorEvent(eventName, properties, {});
}
class TelemetryUtils {
    ...
    fillinProjectTypeProperties(props, projectTypeRes) {
        const newProps = {
            ...
            [ProjectTypeProps.TeamsManifestCapabilities]: projectTypeRes.manifestCapabilities?.join(",") || "",
