import { AxiosError, AxiosInstance, AxiosResponse, CreateAxiosDefaults, InternalAxiosRequestConfig } from "axios";
import { MOS3Api } from "../component/m365/serviceConstant";
/**
...
export declare class WrappedAxiosClient {
     ...
     * @returns
     */
    private static isGraphApi;
    private static isMOSApi;
    private static isTeamsGraphApi;
    private static extractMOSPath;
