...
declare class EnvUtil {
    ...
    resetEnv(projectPath: string, env: string, ignoreKeys: string[]): Promise<void>;
    resetEnvFile(envFilePath: string, ignoreKeys: string[]): Promise<void>;
}
export declare const envUtil: EnvUtil;
type DotenvParsedLine = string | {
    key: string;
    value: string;
    comment?: string;
    quote?: '"' | "'";
