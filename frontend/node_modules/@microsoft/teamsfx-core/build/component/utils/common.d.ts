import { FxError, LogProvider, Result, Warning } from "@microsoft/teamsfx-api";
...
export declare function expandEnvironmentVariable(content: string, envs?: {
...
export declare function outputScaffoldingWarningMessage(warnings: Warning[]): string;
export {};
