...
exports.resourceGroupHelper = exports.newResourceGroupOption = exports.resourceGroupHelperDeps = void 0;
...
const createSubscriptionClient = (token) => new arm_subscriptions_1.SubscriptionClient(token);
exports.resourceGroupHelperDeps = {
...
function selectResourceGroupQuestion(azureAccountProvider, subscriptionId) {
    return {
        ...
        dynamicOptions: async (inputs) => {
            const rmClient = await azureClient_1.azureClientHelper.createRmClient(azureAccountProvider, subscriptionId);
...
class ResourceGroupHelper {
    ...
    async getLocations(azureAccountProvider, rmClient) {
        ...
        const subscriptionClient = exports.resourceGroupHelperDeps.createSubscriptionClient(azureToken);
        ...
        try {
            ...
            const resourceTypeData = providerData.resourceTypes?.find((rt) => rt.resourceType?.toLowerCase() === ResourceGroups.toLowerCase());
