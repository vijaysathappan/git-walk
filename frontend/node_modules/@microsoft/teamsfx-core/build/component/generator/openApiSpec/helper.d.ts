 ...
 */
import { ErrorResult as ApiSpecErrorResult, ErrorType as ApiSpecErrorType, AuthType, ProjectType, SpecParser, SpecParserError, WarningResult } from "@microsoft/m365-spec-parser";
...
export declare function injectAuthAction(projectPath: string, authName: string, authScheme: AuthType | undefined, outputApiSpecPath: string, forceToAddNew: boolean, authType?: string, enablePKCE?: boolean, registrationId?: string): Promise<AuthActionInjectResult | undefined>;
/**
...
export declare function getEnvName(authName: string): string;
export declare function copyKiotaFolder(specPath: string, projectPath: string): Promise<void>;
export declare function generateAdaptiveCardInPluginManifestForKiota(pluginManifestPath: string, specPath: string, context: Context): Promise<void>;
