...
export declare class FuncToolChecker implements DepsChecker {
    ...
    getDepsInfo(funcVersion: FuncVersion | undefined, binFolder: string | undefined, error?: UserError): Promise<DependencyStatus>;
    ...
    queryFuncVersion(funcBinFolder: string | undefined): Promise<FuncVersion>;
    private hasNPM;
    private cleanup;
    private installFunc;
