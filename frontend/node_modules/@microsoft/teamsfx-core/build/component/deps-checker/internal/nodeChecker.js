    ...
    async getInstallationInfo(installOptions) {
        ...
        try {
            ...
            if (currentVersion === null) {
                ...
                const error = new error_1.NodejsNotFoundError();
            ...
            return await this.getDepsInfo(false, supportedVersions, undefined, new error_1.DepsCheckerError(error.message, helpLink_1.nodeNotFoundHelpLink));
        }
    }
...
class LtsNodeChecker extends NodeChecker {
    _nodeNotFoundHelpLink = helpLink_1.v3NodeNotFoundHelpLink;
    _nodeNotSupportedEvent = telemetry_1.DepsCheckerEvent.nodeNotLts;
    _type = depsChecker_1.DepsType.LtsNode;
    _minErrorVersion = Number.MIN_SAFE_INTEGER;
    _maxErrorVersion = Number.MAX_SAFE_INTEGER;
    getSupportedVersions() {
        return Promise.resolve(["22", "24"]);
    }
    ...
    getVersionNotSupportedError(supportedVersions, version) {
        ...
        return new error_1.NodejsNotLtsError(version.version, supportedVersionsString);
    }
}
exports.LtsNodeChecker = LtsNodeChecker;
class ProjectNodeChecker extends NodeChecker {
    _nodeNotFoundHelpLink = helpLink_1.v3NodeNotFoundHelpLink;
    _nodeNotSupportedEvent = telemetry_1.DepsCheckerEvent.nodeNotSupportedForProject;
    _type = depsChecker_1.DepsType.ProjectNode;
    _minErrorVersion = Number.MIN_SAFE_INTEGER;
    _maxErrorVersion = Number.MAX_SAFE_INTEGER;
    ...
    getVersionNotSupportedError(supportedVersions, version) {
        ...
        return new error_1.NodejsNotRecommendedError(version.version, supportedVersionsString);
    }
}
