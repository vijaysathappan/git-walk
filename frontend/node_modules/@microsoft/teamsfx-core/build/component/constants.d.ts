...
export declare const LocalMcpPrefix = "mcp://";
...
export declare const OpenAIEnvironmentVariables: {
    OPENAI_API_KEY: string;
    AZURE_OPENAI_API_KEY: string;
    SECRET_OPENAI_API_KEY: string;
    SECRET_AZURE_OPENAI_API_KEY: string;
    AZURE_OPENAI_ENDPOINT: string;
    AZURE_OPENAI_DEPLOYMENT_NAME: string;
    AZURE_OPENAI_MODEL_DEPLOYMENT_NAME: string;
    OPENAI_ASSISTANT_ID: string;
    AZURE_OPENAI_ASSISTANT_ID: string;
    AZURE_OPENAI_EMBEDDING_DEPLOYMENT: string;
    AZURE_OPENAI_EMBEDDING_DEPLOYMENT_NAME: string;
};
export declare const AzureEnvironmentVariables: {
    AZURE_SEARCH_KEY: string;
    SECRET_AZURE_SEARCH_KEY: string;
