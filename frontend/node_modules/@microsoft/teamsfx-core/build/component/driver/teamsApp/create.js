...
let CreateTeamsAppDriver = class CreateTeamsAppDriver {
    description = (0, localizeUtils_1.getLocalizedString)("driver.teamsApp.description.createDriver");
    progressTitle = (0, localizeUtils_1.getLocalizedString)("driver.teamsApp.progressBar.createTeamsAppStepMessage");
    ...
    async create(args, context, outputEnvVarNames) {
        if ((0, accountUtils_1.isSovereignHigh)()) {
            context.logProvider.warning((0, localizeUtils_1.getLocalizedString)("driver.teamsApp.warning.createUnsupportedCloud", actionName));
        }
        ...
        outputEnvVarNames = new Map([...Object.entries(exports.internalOutputNames), ...outputEnvVarNames]);
        const state = (0, utils_1.loadStateFromEnv)(outputEnvVarNames);
        if ((0, accountUtils_1.isSovereignHigh)()) {
            let teamsAppId = state.teamsAppId;
            if (teamsAppId && (0, isUUID_1.default)(teamsAppId)) {
                context.addSummary((0, localizeUtils_1.getLocalizedString)("driver.teamsApp.summary.createTeamsAppAlreadyExists", teamsAppId));
            }
            else {
                teamsAppId = (0, uuid_1.v4)();
            }
            return (0, teamsfx_api_1.ok)(new Map([[outputEnvVarNames.get("teamsAppId"), teamsAppId]]));
        }
        let create = true;
...
exports.CreateTeamsAppDriver = CreateTeamsAppDriver = tslib_1.__decorate([
