...
class ManifestUtils {
    ...
    async resolveLocFile(locFilePath, context) {
        ...
        if (context) {
            const processedFunctionRes = await (0, envFunctionUtils_1.expandVariableWithFunction)(locFileString, context, undefined, true, envFunctionUtils_1.ManifestType.TeamsManifest, locFilePath);
        ...
        resolvedLocFileString = (0, common_2.expandEnvironmentVariable)(resolvedLocFileString);
