...
exports.teamsappMgr = exports.teamsAppMgrDeps = void 0;
...
exports.teamsAppMgrDeps = {
    runForTypeSpecProject: tools_1.runForTypeSpecProject,
};
class TeamsAppMgr {
    ...
    async packageTeamsApp(inputs) {
        ...
        // For TSP projects
        await exports.teamsAppMgrDeps.runForTypeSpecProject(inputs.projectPath, driverContext);
    ...
    async publishTeamsApp(inputs) {
        ...
        void driverContext.ui?.showMessage("info", `publish successfully, Go to admin portal: ${constants_2.Constants.TEAMS_ADMIN_PORTAL}`, false);
        return (0, teamsfx_api_1.ok)(undefined);
    }
}
