...
import { AzureUploadConfig, DeployContext, DeployStepArgs } from "../../../interface/buildAndDeployArgs";
...
export declare class AzureZipDeployImpl extends AzureDeployImpl {
     ...
     * @protected
     */
    protected packageToZip(args: DeployStepArgs, context: DeployContext): Promise<ReadStream>;
    /**
     ...
     * @protected
     */
    zipDeployPackage(zipDeployEndpoint: string, zipBuffer: ReadStream, config: AzureUploadConfig, logger: LogProvider): Promise<string>;
    /**
     * create azure zip deploy endpoint
     * @param azureResource resource id of the website
     * @param config azure upload config, including azure account credential
     */
    static getZipDeployEndpoint(azureResource: AzureResourceInfo, config: AzureUploadConfig): Promise<string>;
    private static readResponseData;
    private static getEnabledHostNames;
