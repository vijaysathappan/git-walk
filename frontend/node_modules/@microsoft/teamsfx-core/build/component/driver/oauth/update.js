...
let UpdateOauthDriver = class UpdateOauthDriver {
    ...
    async execute(args, context, outputEnvVarNames) {
        ...
        try {
            ...
            const getOauthRes = await teamsGraphClient_1.teamsGraphClient.getOauthRegistrationById(appStudioToken, args.configurationId);
            ...
            await teamsGraphClient_1.teamsGraphClient.updateOauthRegistration(appStudioToken, oauth, args.configurationId);
    ...
    compareOauthRegistration(current, input, authInfo) {
        ...
        if (!isMicrosoftEntra &&
            ...
            diffMsgs.push(`tokenRefreshEndpoint: ${current.tokenRefreshEndpoint} => ${authInfo.tokenRefreshEndpoint ?? "Undefined"}`);
        }
        // Compare scopes
        if (!isMicrosoftEntra &&
            authInfo.scopes &&
...
exports.UpdateOauthDriver = UpdateOauthDriver = tslib_1.__decorate([
