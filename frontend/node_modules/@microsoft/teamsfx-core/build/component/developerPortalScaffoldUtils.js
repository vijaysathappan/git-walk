...
exports.developerPortalScaffoldUtils = exports.DeveloperPortalScaffoldUtils = exports.answerToReplaceMessageExtensionBotId = exports.answerToRepaceBotId = void 0;
...
async function updateManifest(ctx, appDefinition, inputs) {
    ...
    const manifestRes = await ManifestUtils_1.manifestUtils._readAppManifest.bind(ManifestUtils_1.manifestUtils)(manifestTemplatePath);
    if (manifestRes.isErr()) {
        return (0, teamsfx_api_1.err)(manifestRes.error);
    }
...
async function updateEnv(appId, projectPath) {
    const localEnvFilePathRes = await pathUtils_1.pathUtils.getEnvFilePath.bind(pathUtils_1.pathUtils)(projectPath, "local");
    ...
    if (!!localEnvFilePathRes.value && (await fs_extra_1.default.pathExists(localEnvFilePathRes.value))) {
        return await envUtil_1.envUtil.writeEnv.bind(envUtil_1.envUtil)(projectPath, "local", {
            TEAMS_APP_ID: appId,
        });
    }
    else {
        return await envUtil_1.envUtil.writeEnv.bind(envUtil_1.envUtil)(projectPath, "dev", {
            TEAMS_APP_ID: appId,
        });
    }
}
