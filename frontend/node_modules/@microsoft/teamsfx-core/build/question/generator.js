...
async function batchGenerate() {
    ...
    await generateCliOptions(_1.questionNodes.regeneratePlugin(), "RegeneratePlugin");
    await generateInputs(_1.questionNodes.regeneratePlugin(), "RegeneratePlugin");
    ...
    await generateCliOptions(_1.questionNodes.addAuthAction(), "AddAuthAction");
    await generateInputs(_1.questionNodes.addAuthAction(), "AddAuthAction");
    await generateCliOptions(_1.questionNodes.addKnowledge(), "AddKnowledge");
    await generateInputs(_1.questionNodes.addKnowledge(), "AddKnowledge");
    await generateCliOptions(_1.questionNodes.setSensitivityLabel(), "SetSensitivityLabel");
    await generateInputs(_1.questionNodes.setSensitivityLabel(), "SetSensitivityLabel");
    await generateCliOptions(_1.questionNodes.share(), "Share");
    await generateInputs(_1.questionNodes.share(), "Share");
    await generateCliOptions(_1.questionNodes.removeSharedAccess(), "removeSharedAccess");
    await generateInputs(_1.questionNodes.removeSharedAccess(), "removeSharedAccess");
}
void batchGenerate();
