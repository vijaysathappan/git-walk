...
export declare const MAX_EMAIL_NUMBER = 20;
...
export declare const DeclarativeAgentApiSpecOptionId = "api-spec";
...
export declare class AddAuthActionAuthTypeOptions {
    static apiKey(): OptionItem;
    static bearerToken(): OptionItem;
    static oauth(): OptionItem;
    static microsoftEntra(): OptionItem;
...
export declare class GCSelectOptions {
    static list(): OptionItem;
    static input(): OptionItem;
}
export declare class KnowledgeSourceOptions {
...
export declare class KnowledgeSearchTypeOptions {
