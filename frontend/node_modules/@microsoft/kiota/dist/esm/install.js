...
export async function ensureKiotaIsPresentInPath(installPath, runtimeDependencies, currentPlatform) {
    if (installPath) {
...
export function getRuntimeDependenciesPackages() {
    if (runtimeJson.runtimeDependencies) {
        return JSON.parse(JSON.stringify(runtimeJson.runtimeDependencies));
    }
