 ...
 */
export declare function getLanguageInformationInternal(): Promise<LanguagesInformation | undefined>;
/**
 ...
 * @throws {Error} Throws an error if the request fails.
 */
export declare function getLanguageInformationForDescription({ descriptionUrl, clearCache }: LanguageInformationConfiguration): Promise<LanguagesInformation | undefined>;
