import { ConsumerOperation, KiotaGenerationLanguage, KiotaResult } from "../types";
 ...
 */
export declare function generateClient(clientGenerationOptions: ClientGenerationOptions): Promise<KiotaResult | undefined>;
