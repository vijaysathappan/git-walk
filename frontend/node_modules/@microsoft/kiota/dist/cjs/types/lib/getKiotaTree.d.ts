 ...
 */
export declare function getKiotaTree({ descriptionPath, includeFilters, excludeFilters, clearCache, includeKiotaValidationRules }: KiotaResultOptions): Promise<KiotaTreeResult | undefined>;
