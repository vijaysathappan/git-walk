...
function installCaCertificate(caCertificatePath = defaults.caCertificatePath, machine = false) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const certStatus = (0, verify_1.getCaCertificateStatus)();
            if (certStatus.status === verify_1.CertificateStatus.Error) {
                throw new Error(`Unable to verify certificate status. ${(_a = certStatus.error) === null || _a === void 0 ? void 0 : _a.message}`);
            }
            // If the certificate is already installed by another instance skip it.
            if (certStatus.status !== verify_1.CertificateStatus.Installed) {
                (0, child_process_1.execSync)(command, { stdio: "pipe" });
            }
            console.log(`You now have trusted access to https://localhost.\nCertificate: ${defaults.localhostCertificatePath}\nKey: ${defaults.localhostKeyPath}`);
        }
        catch (error) {
            throw new Error(`Unable to install the CA certificate. ${(_c = (_b = error.stderr) === null || _b === void 0 ? void 0 : _b.toString()) !== null && _c !== void 0 ? _c : error.message}`);
        }
    });
}
