...
class BrowserCacheManager extends CacheManager {
    ...
    async migrateIdTokens(credentialSchema, accountSchema, correlationId) {
        ...
        for (const idTokenKey of [...credentialKeysToMigrate.idToken]) {
            ...
            const claims = AuthToken.extractTokenClaims(oldSchemaData.secret, base64Decode, correlationId);
            ...
            const currentTokenHasSignInState = currentIdToken &&
                Object.keys(AuthToken.extractTokenClaims(currentIdToken.secret, base64Decode, correlationId) || {}).includes("signin_state");
            /**
             * Only migrate if:
    ...
    async hydrateCache(result, request) {
        ...
        return this.saveCacheRecord(cacheRecord, result.correlationId, AuthToken.isKmsi(AuthToken.extractTokenClaims(result.idToken, base64Decode, result.correlationId)), ApiId.hydrateCache);
    }
    /**
