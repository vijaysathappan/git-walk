...
class ResetPasswordCodeRequiredState extends ResetPasswordState {
    ...
    async submitCode(code) {
        try {
            ...
            this.stateParameters.logger.errorPii(`1wtelk ${error}`, this.stateParameters.correlationId);
    ...
    async resendCode() {
        try {
            ...
            this.stateParameters.logger.errorPii(`1vyfic ${error}`, this.stateParameters.correlationId);
