...
class SignUpCodeRequiredState extends SignUpState {
    ...
    async submitCode(code) {
        try {
            ...
            this.stateParameters.logger.errorPii(`1y64s9 ${error}`, this.stateParameters.correlationId);
    ...
    async resendCode() {
        try {
            ...
            this.stateParameters.logger.errorPii(`04co5l ${error}`, this.stateParameters.correlationId);
