...
class MfaState extends AuthFlowActionRequiredStateBase {
    ...
    async requestChallenge(authMethodId) {
        try {
            ...
            this.stateParameters.logger.verbose(`1cnvk7 ${authMethodId}`, this.stateParameters.correlationId);
            const requestParams = {
            ...
            this.stateParameters.logger.errorPii(`0bt3wx ${error}`, this.stateParameters.correlationId);
...
class MfaVerificationRequiredState extends MfaState {
    ...
    async submitChallenge(challenge) {
        try {
            ...
            this.stateParameters.logger.errorPii(`01ok2b ${error}`, this.stateParameters.correlationId);
