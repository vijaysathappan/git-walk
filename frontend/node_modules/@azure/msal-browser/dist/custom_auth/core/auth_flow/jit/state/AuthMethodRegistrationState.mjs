...
class AuthMethodRegistrationState extends AuthFlowActionRequiredStateBase {
    ...
    async challengeAuthMethodInternal(authMethodDetails) {
        try {
            this.stateParameters.logger.verbose(`0vi650 ${authMethodDetails.authMethodType.id}`, this.stateParameters.correlationId);
            ...
            this.stateParameters.logger.errorPii(`17im04 ${error}`, this.stateParameters.correlationId);
...
class AuthMethodVerificationRequiredState extends AuthMethodRegistrationState {
    ...
    async submitChallenge(code) {
        try {
            ...
            this.stateParameters.logger.errorPii(`0njepo ${error}`, this.stateParameters.correlationId);
