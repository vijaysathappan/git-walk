...
import { name } from '../../packageMetadata.mjs';
...
class CustomAuthStandardController extends StandardController {
    ...
    getCurrentAccount(accountRetrievalInputs) {
        ...
        try {
            ...
            this.logger.errorPii(`0ar5hw ${error}`, correlationId);
    ...
    async signIn(signInInputs) {
        ...
        try {
            ...
            this.logger.verbose(`0mncjk ${!!signInInputs.password ? "with" : "without"}`, correlationId);
            ...
            this.logger.errorPii(`1te6co ${error}`, correlationId);
            return SignInResult.createWithError(error);
        }
    }
    /*
    ...
    async signUp(signUpInputs) {
        ...
        try {
            ...
            this.ensureUserNotSignedIn(correlationId);
            this.logger.verbose(`1f4ezz ${!!signUpInputs.password
            ...
            this.logger.errorPii(`1ym5p8 ${error}`, correlationId);
    ...
    async resetPassword(resetPasswordInputs) {
        ...
        try {
            ...
            this.logger.errorPii(`1s0wwh ${error}`, correlationId);
