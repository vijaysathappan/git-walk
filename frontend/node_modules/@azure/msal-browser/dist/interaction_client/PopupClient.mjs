...
import { preconnect, getCurrentUri, waitForBridgeResponse } from '../utils/BrowserUtils.mjs';
import { buildPopupRelayUrl, waitForPopupRelayResponse } from '../popup_relay/relayClient.mjs';
import { base64Decode } from '../encode/Base64Decode.mjs';
import { createBrowserAuthError } from '../error/BrowserAuthError.mjs';
import { deserializeResponse } from '../response/ResponseHandler.mjs';
import { getAuthCodeRequestUrl, handleResponseCode, handleResponseEAR, getEARFormData, getCodeFormData, getEARForm, getCodeForm } from '../protocol/Authorize.mjs';
...
class PopupClient extends StandardInteractionClient {
    ...
    getRelayStateId(state, correlationId) {
        return ProtocolUtils.parseRequestState(base64Decode, state, correlationId).libraryState.id;
    }
    /**
