    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        switch (process.platform) {
            case "win32": {
                ...
                throw new office_addin_usage_data_1.ExpectedError("The source bundle override file path is not specified or is invalid.");
            }
            default:
                throw new office_addin_usage_data_1.ExpectedError(`Platform not supported: ${process.platform}.`);
        }
...
function isValidBundleOverrideFilePath(path) {
    let isValid = false;
    try {
        if (path) {
            const pathExists = fs_1.default.existsSync(path);
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        switch (process.platform) {
            case "win32": {
                ...
                if (path && isValidPath) {
                    yield devSettingsWindows.enableDiskManifests(path);
                    return path;
                }
                throw new office_addin_usage_data_1.ExpectedError("The disk manifests path is not specified or is invalid. Ensure that it is an existing directory path.");
            }
            default:
                throw new office_addin_usage_data_1.ExpectedError(`Platform not supported: ${process.platform}.`);
        }
...
function isValidDiskManifestsPath(path) {
    let isValid = false;
    try {
        if (path) {
            const pathExists = fs_1.default.existsSync(path);
