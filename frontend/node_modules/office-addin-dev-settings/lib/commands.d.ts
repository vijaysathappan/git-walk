...
export declare function sourceBundleOverrideFile(addInId: string, options: OptionValues): Promise<void>;
...
export declare function isSourceBundleOverriden(addInId: string): Promise<void>;
export declare function diskManifests(options: OptionValues): Promise<void>;
export declare function enableDiskManifests(path?: string): Promise<void>;
export declare function disableDiskManifests(): Promise<void>;
export declare function areDiskManifestsEnabled(): Promise<void>;
