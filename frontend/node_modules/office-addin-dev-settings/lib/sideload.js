 ...
 */
function generateSideloadUrl(manifestFileName_1, manifest_1, documentUrl_1) {
    return tslib_1.__awaiter(this, arguments, void 0, function* (manifestFileName, manifest, documentUrl, isTest = false) {
 ...
 * @param canPrompt
 */
function sideloadAddIn(manifestPath_1, app_1) {
    return tslib_1.__awaiter(this, arguments, void 0, function* (manifestPath, app, canPrompt = false, launchOnly = false, appType, document, registration) {
        try {
