 ...
 * @param canPrompt
 */
export declare function sideloadAddIn(manifestPath: string, app?: OfficeApp, canPrompt?: boolean, launchOnly?: boolean, appType?: AppType, document?: string, registration?: string): Promise<void>;
